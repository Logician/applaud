...
class AndroidToIosAppMappingDetailField(StringEnum):
    PACKAGE_NAME = 'packageName'
    APP_SIGNING_KEY_PUBLIC_CERTIFICATE_SHA256_FINGERPRINTS = 'appSigningKeyPublicCertificateSha256Fingerprints'
...
class GameCenterAchievementVersionField(StringEnum):
    VERSION = 'version'
    STATE = 'state'
...
class GameCenterLeaderboardSetVersionField(StringEnum):
    VERSION = 'version'
    STATE = 'state'
    LEADERBOARD_SET = 'leaderboardSet'
    LOCALIZATIONS = 'localizations'

class GameCenterLeaderboardVersionField(StringEnum):
    VERSION = 'version'
    STATE = 'state'
    LEADERBOARD = 'leaderboard'
    LOCALIZATIONS = 'localizations'
...
class InAppPurchaseOfferCodeCustomCodeField(StringEnum):
...
class InAppPurchaseOfferCodeOneTimeUseCodeField(StringEnum):
    NUMBER_OF_CODES = 'numberOfCodes'
    CREATED_DATE = 'createdDate'
    EXPIRATION_DATE = 'expirationDate'
    ACTIVE = 'active'
...
class InAppPurchaseOfferCodeField(StringEnum):
    NAME = 'name'
    CUSTOMER_ELIGIBILITIES = 'customerEligibilities'
    PRODUCTION_CODE_COUNT = 'productionCodeCount'
    SANDBOX_CODE_COUNT = 'sandboxCodeCount'
    ACTIVE = 'active'
    ONE_TIME_USE_CODES = 'oneTimeUseCodes'
    CUSTOM_CODES = 'customCodes'
    PRICES = 'prices'

class InAppPurchaseOfferPriceField(StringEnum):
    TERRITORY = 'territory'
