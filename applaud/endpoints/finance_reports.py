...
class FinanceReportsEndpoint(Endpoint):
    ...
    def filter(self, *, vendor_number: Union[str, list[str]], report_type: Union[ReportType, list[ReportType]], region_code: Union[str, list[str]], report_date: Union[str, list[str]]) -> FinanceReportsEndpoint:
