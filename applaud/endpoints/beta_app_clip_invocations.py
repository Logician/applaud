...
class BetaAppClipInvocationEndpoint(IDEndpoint):
    ...
    def get_all(self) -> BetaAppClipInvocationResponse:
        '''
        Get all resources.
        ...
        '''
        json = super()._perform_get()
        response = BetaAppClipInvocationResponse.parse_obj(json)
        while response.links.next != None:
            json = super()._perform_get_next(next = response.links.next)
            response2 = BetaAppClipInvocationResponse.parse_obj(json)
