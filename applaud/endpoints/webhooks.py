...
class DeliveriesLinkagesOfWebhookEndpoint(IDEndpoint):
    ...
    def get_all(self) -> WebhookDeliveriesLinkagesResponse:
        '''
        Get all resources.
        ...
        '''
        json = super()._perform_get()
        response = WebhookDeliveriesLinkagesResponse.parse_obj(json)
        while response.links.next != None:
            json = super()._perform_get_next(next = response.links.next)
            response2 = WebhookDeliveriesLinkagesResponse.parse_obj(json)
...
class DeliveriesOfWebhookEndpoint(IDEndpoint):
    ...
    def get_all(self) -> WebhookDeliveriesResponse:
        '''
        Get all resources.
        ...
        '''
        json = super()._perform_get()
        response = WebhookDeliveriesResponse.parse_obj(json)
        while response.links.next != None:
            json = super()._perform_get_next(next = response.links.next)
            response2 = WebhookDeliveriesResponse.parse_obj(json)
            response.data.extend(response2.data)
            response.links = response2.links
        return response
