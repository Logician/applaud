...
class AlternativeDistributionPackage(ApplaudModel):
    class Attributes(ApplaudModel):
        source_file_checksum: Optional[Checksums] = None
...
class AndroidToIosAppMappingDetail(ApplaudModel):
    class Attributes(ApplaudModel):
...
class AppInfo(ApplaudModel):
    class Attributes(ApplaudModel):
        ...
        kids_age_band: Optional[KidsAgeBand] = Field(None, deprecated=True)
...
class App(ApplaudModel):
    ...
    class Relationships(ApplaudModel):
        ...
        class AppStoreIcon(ApplaudModel):
            class Data(ApplaudModel):
                id: str
        ...
        class AndroidToIosAppMappingDetails(ApplaudModel):
            class Data(ApplaudModel):
                id: str
                type: Literal["androidToIosAppMappingDetails"] = "androidToIosAppMappingDetails"
        ...
        app_store_icon: Optional[AppStoreIcon] = None
        ...
        android_to_ios_app_mapping_details: Optional[AndroidToIosAppMappingDetails] = None
...
class BackgroundAssetVersion(ApplaudModel):
    class Attributes(ApplaudModel):
        class StateDetails(ApplaudModel):
...
class BetaTester(ApplaudModel):
    class Attributes(ApplaudModel):
        class AppDevice(ApplaudModel):
            ...
            platform: Optional[Platform] = None
            os_version: Optional[str] = None
            app_build_version: Optional[str] = None
        ...
        app_devices: Optional[list[AppDevice]] = None
...
class GameCenterAchievementImageV2(ApplaudModel):
    class Attributes(ApplaudModel):
        file_size: Optional[int] = None
        file_name: Optional[str] = None
        image_asset: Optional[ImageAsset] = None
...
class GameCenterAchievementLocalizationV2(ApplaudModel):
    class Attributes(ApplaudModel):
        locale: Optional[str] = None
        name: Optional[str] = None
...
class GameCenterAchievementVersionV2(ApplaudModel):
    class Attributes(ApplaudModel):
        version: Optional[int] = None
...
class GameCenterAchievementVersionV2InlineCreate(ApplaudModel):
    class Relationships(ApplaudModel):
        class Achievement(ApplaudModel):
            class Data(ApplaudModel):
                id: str
...
class GameCenterAchievementV2(ApplaudModel):
    class Attributes(ApplaudModel):
        reference_name: Optional[str] = None
...
class GameCenterActivity(ApplaudModel):
    ...
    class Relationships(ApplaudModel):
        ...
        class AchievementsV2(ApplaudModel):
            class Data(ApplaudModel):
                id: str
                type: Literal["gameCenterAchievements"] = "gameCenterAchievements"
        ...
        class LeaderboardsV2(ApplaudModel):
            class Data(ApplaudModel):
                id: str
                type: Literal["gameCenterLeaderboards"] = "gameCenterLeaderboards"
        ...
        game_center_detail: Optional[GameCenterDetail] = None
        game_center_group: Optional[GameCenterGroup] = None
        achievements: Optional[Achievements] = Field(None, deprecated=True)
        achievements_v2: Optional[AchievementsV2] = None
        leaderboards: Optional[Leaderboards] = Field(None, deprecated=True)
        leaderboards_v2: Optional[LeaderboardsV2] = None
        versions: Optional[Versions] = None
...
class GameCenterActivityVersionInlineCreate(ApplaudModel):
    class Attributes(ApplaudModel):
        fallback_url: Optional[str] = None
...
class GameCenterChallengeVersionInlineCreate(ApplaudModel):
    class Relationships(ApplaudModel):
        class Challenge(ApplaudModel):
            class Data(ApplaudModel):
                id: str
...
class GameCenterDetail(ApplaudModel):
    ...
    class Relationships(ApplaudModel):
        ...
        class GameCenterLeaderboardsV2(ApplaudModel):
            class Data(ApplaudModel):
                id: str
                type: Literal["gameCenterLeaderboards"] = "gameCenterLeaderboards"
        ...
        class GameCenterLeaderboardSetsV2(ApplaudModel):
            class Data(ApplaudModel):
                id: str
                type: Literal["gameCenterLeaderboardSets"] = "gameCenterLeaderboardSets"
        ...
        class GameCenterAchievementsV2(ApplaudModel):
            class Data(ApplaudModel):
                id: str
                type: Literal["gameCenterAchievements"] = "gameCenterAchievements"
        ...
        game_center_group: Optional[GameCenterGroup] = None
        game_center_leaderboards: Optional[GameCenterLeaderboards] = Field(None, deprecated=True)
        game_center_leaderboards_v2: Optional[GameCenterLeaderboardsV2] = None
        game_center_leaderboard_sets: Optional[GameCenterLeaderboardSets] = Field(None, deprecated=True)
        game_center_leaderboard_sets_v2: Optional[GameCenterLeaderboardSetsV2] = None
        game_center_achievements: Optional[GameCenterAchievements] = Field(None, deprecated=True)
        game_center_achievements_v2: Optional[GameCenterAchievementsV2] = None
        ...
        achievement_releases: Optional[AchievementReleases] = Field(None, deprecated=True)
        activity_releases: Optional[ActivityReleases] = Field(None, deprecated=True)
        challenge_releases: Optional[ChallengeReleases] = Field(None, deprecated=True)
        leaderboard_releases: Optional[LeaderboardReleases] = Field(None, deprecated=True)
        leaderboard_set_releases: Optional[LeaderboardSetReleases] = Field(None, deprecated=True)
...
class GameCenterLeaderboardImageV2(ApplaudModel):
    class Attributes(ApplaudModel):
        file_size: Optional[int] = None
        file_name: Optional[str] = None
        image_asset: Optional[ImageAsset] = None
...
class GameCenterLeaderboardLocalizationV2(ApplaudModel):
    class Attributes(ApplaudModel):
        locale: Optional[str] = None
        name: Optional[str] = None
        formatter_override: Optional[GameCenterLeaderboardFormatter] = None
...
class GameCenterLeaderboardSetImageV2(ApplaudModel):
    class Attributes(ApplaudModel):
        file_size: Optional[int] = None
        file_name: Optional[str] = None
        image_asset: Optional[ImageAsset] = None
...
class GameCenterLeaderboardSetLocalizationV2(ApplaudModel):
    class Attributes(ApplaudModel):
        locale: Optional[str] = None
        name: Optional[str] = None
...
class GameCenterLeaderboardSetVersionV2(ApplaudModel):
    class Attributes(ApplaudModel):
        version: Optional[int] = None
        state: Optional[GameCenterVersionState] = None
    ...
    class Relationships(ApplaudModel):
        ...
        leaderboard_set: Optional[LeaderboardSet] = None
        localizations: Optional[Localizations] = None
...
class GameCenterLeaderboardSetVersionV2InlineCreate(ApplaudModel):
    class Relationships(ApplaudModel):
        class LeaderboardSet(ApplaudModel):
            class Data(ApplaudModel):
                id: str
...
class GameCenterLeaderboardSetV2(ApplaudModel):
    class Attributes(ApplaudModel):
        reference_name: Optional[str] = None
        vendor_identifier: Optional[str] = None
...
class GameCenterLeaderboardVersionV2(ApplaudModel):
    class Attributes(ApplaudModel):
        version: Optional[int] = None
        state: Optional[GameCenterVersionState] = None
...
class GameCenterLeaderboardVersionV2InlineCreate(ApplaudModel):
    class Relationships(ApplaudModel):
        class Leaderboard(ApplaudModel):
            class Data(ApplaudModel):
                id: str
...
class GameCenterLeaderboardV2(ApplaudModel):
    class Attributes(ApplaudModel):
        class SubmissionType(StringEnum):
            BEST_SCORE = 'BEST_SCORE'
            MOST_RECENT_SCORE = 'MOST_RECENT_SCORE'
...
class InAppPurchaseOfferCodeCustomCode(ApplaudModel):
    class Attributes(ApplaudModel):
    ...
    class Relationships(ApplaudModel):
        ...
        class DeactivatedByActor(ApplaudModel):
            class Data(ApplaudModel):
                id: str
                type: Literal["actors"] = "actors"
        ...
        deactivated_by_actor: Optional[DeactivatedByActor] = None
...
class InAppPurchaseOfferCodeOneTimeUseCodeValue(ApplaudModel):
    id: str
    type: Literal["inAppPurchaseOfferCodeOneTimeUseCodeValues"] = "inAppPurchaseOfferCodeOneTimeUseCodeValues"
    links: Optional[ResourceLinks] = None

class InAppPurchaseOfferCodeOneTimeUseCode(ApplaudModel):
    class Attributes(ApplaudModel):
        number_of_codes: Optional[int] = None
        created_date: Optional[datetime.datetime] = None
        expiration_date: Optional[datetime.date] = None
...
class InAppPurchaseOfferCode(ApplaudModel):
    class Attributes(ApplaudModel):
        name: Optional[str] = None
        customer_eligibilities: Optional[list[str]] = None
        production_code_count: Optional[int] = None
        sandbox_code_count: Optional[int] = None
        active: Optional[bool] = None
...
class InAppPurchaseOfferPrice(ApplaudModel):
    class Relationships(ApplaudModel):
        class Territory(ApplaudModel):
            class Data(ApplaudModel):
                id: str
...
class InAppPurchaseOfferPriceInlineCreate(ApplaudModel):
    class Relationships(ApplaudModel):
        class Territory(ApplaudModel):
            class Data(ApplaudModel):
                id: str
...
class ErrorLinks(ApplaudModel):
    ...
    associated: Optional[Union[str, AssociatedOption2]] = None
