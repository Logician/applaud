...
class BackgroundAssetVersionAppStoreReleaseState(StringEnum):
    PREPARE_FOR_SUBMISSION = 'PREPARE_FOR_SUBMISSION'
    READY_FOR_REVIEW = 'READY_FOR_REVIEW'
    WAITING_FOR_REVIEW = 'WAITING_FOR_REVIEW'
    IN_REVIEW = 'IN_REVIEW'
...
class BackgroundAssetVersionExternalBetaReleaseState(StringEnum):
...
class BuildUploadState(StringEnum):
    AWAITING_UPLOAD = 'AWAITING_UPLOAD'
    PROCESSING = 'PROCESSING'
    FAILED = 'FAILED'
    COMPLETE = 'COMPLETE'
...
class ChecksumAlgorithm(StringEnum):
    MD5 = 'MD5'
    SHA_256 = 'SHA_256'
...
class OfferCodeEnvironment(StringEnum):
